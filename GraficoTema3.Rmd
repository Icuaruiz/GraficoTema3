---
title: "GraficoTema3"
author: "Iker Cuadros Ruiz, Guillem García Garro"
date: "2024-02-19"
output:
...
grafico <- ggplot(df.covid.filtered, aes(x = date, y = new_deaths_smoothed_per_million)) +
  ...
  scale_x_date(date_labels = ("%b %d,%Y")#, breaks = as.Date(c("2020-02-13","2020-08-08", "2020-11-16", "2021-02-24", "2021-06-4", "2021-09-12", "2022-02-28"))
               ) +
  scale_y_continuous(limits = c(0,21), breaks = seq(0, max(df.covid.filtered$new_deaths_per_million/7), by = 2))
